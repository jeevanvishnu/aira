      ...
      <div className="footer-classic-container">
        ...
        <div className="footer-col-brand">
          ...
          <div className="footer-social-icons">
            <a href="https://www.facebook.com/profile.php?id=61577557102396" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            ...
            <a href="https://www.instagram.com/airajewels.uae/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a href="https://www.tiktok.com/@airajewels?_t=ZN-8yQLIcJXMko&_r=1" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
              <i className="fa-brands fa-tiktok" style={{ fontSize: '18px' }}></i>
            </a>
            <a href="https://in.pinterest.com/airajewels916/" target="_blank" rel="noopener noreferrer" aria-label="Pinterest">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M8 20.5l3-7c0 0-1-2 0-4c1-2 4-2 4 0c0 2-2 4-2 6c0 2 2 3 4 1c2-3 1-8-3-8c-4 0-7 3-7 7c0 2 1 3 1 3s-1 1-1 1c-1-2-1-4-1-6"></path></svg>
            </a>
            <a href="tel:+971501847916" aria-label="Phone Call">
        ...
        <div className="footer-col-contact">
          ...
          <div className="contact-details-footer">
            <p style={{ alignItems: 'flex-start' }}>
              ...
              <span>+971 50 184 7916<br/>(06) 564 6425</span>
            </p>
            <p>
